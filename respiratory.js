const data = {
    ...
    nostril: {
        ...
        desc: "Nostrils are the two external openings of the nose through which air enters the respiratory system. They help filter large dust particles using hairs and mucus."
    },

    nasalCavity: {
        name: "Nasal Cavity",
        image: "https://media.sciencephoto.com/image/f0164882/800wm/F0164882-Human_nasal_cavity,_illustration.jpg",
        desc: "The nasal cavity is a hollow space inside the nose that warms, moistens, and filters incoming air before it passes to the pharynx."
    },

    pharynx: {
        name: "Pharynx",
        image: "https://as2.ftcdn.net/v2/jpg/05/75/74/51/1000_F_575745121_3bzwHyLlCFvFhfXmcreJWoy6nAOO2zIm.jpg",
        desc: "The pharynx is a common passage for both air and food. It carries air from the nasal cavity to the larynx during breathing."
    },

    larynx: {
        name: "Larynx",
        image: "https://as1.ftcdn.net/v2/jpg/05/18/24/54/1000_F_518245446_jCEP0A91qcKUs2SXkLRAOpzRtVcfoala.jpg",
        desc: "The larynx, also called the voice box, allows air to pass into the trachea and helps in sound production during speech."
    },
